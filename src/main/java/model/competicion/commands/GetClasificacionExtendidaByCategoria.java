...
public class GetClasificacionExtendidaByCategoria {
	...
	public List<ClasificacionExtendidaDto> execute() {
		List<ClasificacionExtendidaDto> noPresentados = db.executeQueryPojo(ClasificacionExtendidaDto.class,
				OBTENER_NO_PRESENTADOS, id_competicion, categoria, id_competicion, categoria);
		for (ClasificacionDto c : noPresentados) {
			c.presentado = false;
		}
		List<ClasificacionExtendidaDto> clasificados = db.executeQueryPojo(ClasificacionExtendidaDto.class,
		...
		return Stream.concat(Stream.concat(
				Stream.concat(clasificados.stream(),
						db.executeQueryPojo(ClasificacionExtendidaDto.class, OBTENER_RESULTADOS_DNF, id_competicion,
								categoria).stream()),
				db.executeQueryPojo(ClasificacionExtendidaDto.class, OBTENER_RESULTADOS_DNS, id_competicion, categoria)
						.stream()),

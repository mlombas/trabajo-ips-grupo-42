...
public class GetClasificacionByCategoria{
	...
	public List<ClasificacionDto> execute() {
		...
		return Stream.concat(Stream.concat(
				Stream.concat(db.executeQueryPojo(ClasificacionDto.class, OBTENER_RESULTADOS, id_competicion, categoria).stream(),
						db.executeQueryPojo(ClasificacionDto.class, OBTENER_RESULTADOS_DNF, id_competicion, categoria).stream()),
				db.executeQueryPojo(ClasificacionDto.class, OBTENER_RESULTADOS_DNS, id_competicion, categoria).stream()),

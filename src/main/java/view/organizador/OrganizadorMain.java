...
public class OrganizadorMain extends JPanel {
	...
	public static final String CONFIGURAR_CATEGORÍAS = "configurar categorias";
	...
	/**
	 * Basic implementation of the AtletasMenu; 1. Here you can select what you want
	 * to do: a. Inscribirse b. Ver inscripciones
	 */
	...
	public GestionarCompeticionesPanel getBuscarCompeticionPane() {
		return buscarCompeticionPane;
	}
